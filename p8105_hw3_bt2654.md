...
# glimpse(ny_noaa)
knitr::kable(summary(ny_noaa), caption = "Summary of Data for Problem 1")
```
...
knitr::kable(missing_data_summary, caption = "Missing Data Summary")
```
...
``` r
knitr::kable(missing_data_percentage, caption = "Missing Data Percentage")
```

|  id | date |    prcp |    snow |     snwd |     tmax |     tmin |
|----:|-----:|--------:|--------:|---------:|---------:|---------:|
|   0 |    0 | 5.61958 | 14.6896 | 22.80331 | 43.71025 | 43.71264 |
...
snowfall_dist_table = head(snowfall_distribution, 5)

knitr::kable(snowfall_dist_table, caption = "Snowfall Distribution Table")
```
...
knitr::kable(education_sex_table, caption = "Education & Sex Table")
```
...
- **High school equivalent:** Both males and females show an increasing
...
- **More than High School:** Participants with higher education levels
...
occupational differences may play a role in shaping these patterns.
...
knitr::kable(summary(cleaned_df), caption = "Summary of Data")
```

|     | ride_id          | rideable_type       | weekdays        | duration        | start_station_name | end_station_name | member_casual | year         | month         |
|:----|:-----------------|:--------------------|:----------------|:----------------|:-------------------|:-----------------|:--------------|:-------------|:--------------|
|     | Length:99253     | classic_bike :55483 | Sunday :11455   | Min. : 1.002    | Length:99253       | Length:99253     | casual:19542  | Min. :2020   | Min. :1.000   |
|     | Class :character | electric_bike:43770 | Monday :14466   | 1st Qu.: 5.587  | Class :character   | Class :character | member:79711  | 1st Qu.:2020 | 1st Qu.:1.000 |
|     | Mode :character  | NA                  | Tuesday :15497  | Median : 9.823  | Mode :character    | Mode :character  | NA            | Median :2024 | Median :7.000 |
|     | NA               | NA                  | Wednesday:16848 | Mean : 13.836   | NA                 | NA               | NA            | Mean :2023   | Mean :5.114   |
|     | NA               | NA                  | Thursday :14992 | 3rd Qu.: 17.515 | NA                 | NA               | NA            | 3rd Qu.:2024 | 3rd Qu.:7.000 |
|     | NA               | NA                  | Friday :13590   | Max. :238.780   | NA                 | NA               | NA            | Max. :2024   | Max. :7.000   |
|     | NA               | NA                  | Saturday :12405 | NA              | NA                 | NA               | NA            | NA           | NA            |
...
knitr::kable(grouped_rides, caption = "Group Rides Table")
```
...
- **Higher Usage in Summer:**
  ...
  - Across all years, July recorded more rides than January for both
...
knitr::kable(top_stations_july_2024, caption = "Top 5 Most Popular Starting Stations")
```
...
Top 5 Most Popular Starting Stations
...
![](p8105_hw3_bt2654_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->
